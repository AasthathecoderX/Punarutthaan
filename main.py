...
def launch_game(game_name):
    ...
    if game_name == "Pagade":
        game_dir = os.path.join(os.getcwd(), "Ludo-Python-game--master")
        game_path = os.path.join(game_dir, "Pagade.py")
    else:
...
def launch_game(game_name):
    ...
    if game_name == "Aadu Puli Aatam":
        ...
        game_path = os.path.join(game_dir, "Lambs-and-Tigers.py")
    else:
        game_dir = os.path.join(os.getcwd(), game_name)
        game_path = os.path.join(game_dir, f"{game_name}.py")
...
def launch_game(game_name):
    ...
    if game_name == "Pallankuzhi":
        game_dir = os.path.join(os.getcwd(), "pallankuzhi20000-main")
